...
CREATE SEQUENCE HF_JOB_SEQ START WITH 1 INCREMENT BY 1;
...
CREATE SEQUENCE HF_JOB_STATE_SEQ START WITH 1 INCREMENT BY 1;
...
CREATE SEQUENCE HF_JOB_PARAMETER_SEQ START WITH 1 INCREMENT BY 1;
...
CREATE SEQUENCE HF_JOB_QUEUE_SEQ START WITH 1 INCREMENT BY 1;

CREATE INDEX IX_HF_JOB_QUEUE_QUEUE_FETCHED ON HF_JOB_QUEUE (QUEUE, FETCHED_AT);
...
CREATE SEQUENCE HF_SET_SEQ START WITH 1 INCREMENT BY 1;
...
-- Counter table - stores aggregated counters
...
CREATE SEQUENCE HF_COUNTER_SEQ START WITH 1 INCREMENT BY 1;
...
CREATE SEQUENCE HF_HASH_SEQ START WITH 1 INCREMENT BY 1;
...
CREATE SEQUENCE HF_LIST_SEQ START WITH 1 INCREMENT BY 1;

CREATE INDEX IX_HF_LIST_KEY ON HF_LIST (KEY_NAME);
...
CREATE SEQUENCE HF_AGG_COUNTER_SEQ START WITH 1 INCREMENT BY 1;
